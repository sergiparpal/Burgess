...
allowed-tools: Task, Bash, mcp__plugin_burgess_burgess__kg_context
---
...
SCRIPTS=/home/sergi/Burgess/scripts
...
- Call **`mcp__plugin_burgess_burgess__kg_context`** with `budget=2000` and no `query`. If it returns an empty
