...
| 4 Materialization + neg. memory | DONE | (stage-4 commit) | kg_diverge_materialize (27 tools): pins→propose lane only, lineage in body; fate-sync folds grounding failures into discards (I8 both paths); adversarial suite 10 tests; verdict neutrality; e2e; suite 989 passed + 2 skipped |
