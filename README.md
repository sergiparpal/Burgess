...
<!-- test-count:begin -->
The suite currently reports: **1032 passed, 2 skipped** (`uv run --extra dev pytest tests/`).
<!-- test-count:end -->
...
Per-file attribution with SHAs and every adaptation: [`docs/fusion/ATTRIBUTION.md`](docs/fusion/ATTRIBUTION.md). Migrating from either donor: [`docs/MIGRATION.md`](docs/MIGRATION.md). How this plugin was built (the full fusion plan and its decision log): [`FUSION_PLAN.md`](FUSION_PLAN.md) + [`docs/fusion/`](docs/fusion/).
